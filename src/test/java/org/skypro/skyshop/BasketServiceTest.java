...
public class BasketServiceTest {
    ...
    @Mock
    private Map<UUID, Integer> productBasket;
    ...
    void testAddExistingProductCallsBasketAddProduct() {
        ...
        verify(productBasket).merge(productId, 1, Integer::sum);
    }

    @Test
    void testGetUserBasketReturnsEmptyBasket() {
        when(productBasket.entrySet()).thenReturn(Collections.emptySet());
    ...
    void testGetUserBasketReturnsFilledBasket() {
        ...
        when(productBasket.entrySet()).thenReturn(Map.of(productId1, 2, productId2, 1).entrySet());
